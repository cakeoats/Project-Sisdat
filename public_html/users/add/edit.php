...
?>
  ...
  <?php echo $msg_content; ?>
										...
										<div class="form-group">
												...
												<div class="col-md-12">
														<select class="form-control" name="dompet" readonly>
														<option value="<?php echo $datadb_tipe['wallet_id']; ?>"><?php echo $datadb_tipe['wallet']; ?></option></select>
												</div>
											</div>
												<div class="form-group">
												<label class="col-md-2 control-label">Dompet</label>
	...
	<select class="form-control" name="category">
												...
												<div class="col-md-12">
											<input type="number" name="saldo" class="form-control" placeholder="Jumlah"value="<?php echo $datadb_tipe['balance']; ?>">
												</div>
											</div>
