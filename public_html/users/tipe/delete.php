						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Delete News</div>
								</div>
								<div class="card-body">
									<div class="row">
							         <div class="col-md-12">
								
										<form class="form-horizontal" role="form" method="POST" action="<?php echo $cfg_baseurl; ?>user/kategori.php">
...
<?php
			...
			header("Location: ".$cfg_baseurl."admin/kategori.php");
		}
	}
} else {
